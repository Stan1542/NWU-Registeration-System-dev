...
<style>
    ...
    <div id="containerPrompt">
        ...
        <button id="applcationButton">Application</button>
    </div>

    <script>
        const adminButton = document.getElementById("adminButton");
        const studentButton = document.getElementById("studentButton");
        const applcationButton = document.getElementById("applcationButton")
        ...
        applcationButton.addEventListener("click", function () {
            // Redirect to the "signup" page
            window.location.href = "Biographical.php";
        });
    </script>
</body>
</html>
